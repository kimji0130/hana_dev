...
// 2019-02-26 �߰�
	...
	// Tab (loan_cont class) 2019-01-17 �߰���
	...
	// �����û �����õ��� ȭ�� 2019-05-23 �߰� // 2019-12-12 �߰� // 2020-01-16 ����
	...
	function btn01(){
		...
		objItem2.click(function(){
			...
			if(!$(this).is('.choice.on')) {
				...
				$(this).children().children().text('��ü �����׸� ���� �Ϸ�');
				...
				$(this).children().children().text('��ü �����ϱ� (�����׸�)');
			}
		});
		objItem4.click(function(){
			objItem2.removeClass('on');
			objItem2.children().children().text('��ü �����ϱ� (�����׸�)');
		});
		objItem6.click(function(){
			...
			$(this).parents('.list_dot_01').each(function(){
				...
				if(exam3 >= exam4){
					...
					objItem2.children().children().text('��ü �����׸� ���� �Ϸ�');
					objItem8.addClass('on');
					objItem8.children().children().text('���� ���� �Ϸ�');
				}else{
					objItem2.removeClass('on');
					objItem2.children().children().text('��ü �����ϱ� (�����׸�)');
					objItem8.removeClass('on');
					objItem8.children().children().text('���� ����');
				}
			});
		});
		...
		//������� üũ �ؽ�Ʈ ��üŸ�� - �迭 name ���� ����
		var txTrsArr1 = ['��ü �����ϱ� (�ʼ��׸�)','��ü �ʼ��׸� ���� �Ϸ�'],
			txTrsArr2 = ['��ü �����ϱ� (�����׸�)','��ü �����׸� ���� �Ϸ�'],
			txTrsArr3 = ['��ü �����ϱ�','��ü ���� �Ϸ�'],//200723
			txTrsArr4 = ['�ʼ� ����','�ʼ� ���� �Ϸ�'],//200723
			txTrsArr5 = ['���� ����','���� ���� �Ϸ�'];//200723
		objItemTrsCk.click(function(){
			...
			var strChk = eval('txTrsArr' + _chkNum); //name �� üũ
			if($(this).hasClass('on')){
...
function focusId(focusId) {
	var areaTop = $("#" + focusId + "DD").offset().top; // �̵��Ϸ��� ��ü�� ���� ��ġ

	var headerHeight1 = $(".header").innerHeight(); // �ֻ�� ���
	var headerHeight2 = $(".cont_header").innerHeight(); // �ι�° ���
